...
func RegisterWithEmailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := user.NewRegisterWithEmailLogic(r.Context(), svcCtx)
		resp, err := l.RegisterWithEmail(req)
		if err != nil {
			httpx.Error(w, err)
		} else {
			httpx.OkJson(w, resp)
